export function renderSlotMachine() {
    ...
    <button type="button" class="btn btn-primary glowing-btn" data-toggle="modal" data-target="#slotMachine">
    
    <span class='glowing-txt'>SL<span class='faulty-letter'>OT</span> MACHINE</span>
      </button>
      
      <!-- Modal -->
      <div class="modal" id="slotMachine" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    document.body.insertAdjacentHTML('afterbegin', SlotMachineHTML);
