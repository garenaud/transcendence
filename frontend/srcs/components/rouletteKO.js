...
/* export function spinWheel(rouletteElement) {
  rouletteElement.querySelector(".winner").textContent = "";
  rouletteElement.querySelector("#winnerMsg").textContent = ``;
  ...
  const bets = rouletteElement.querySelectorAll(".active");
  console.log(bets);
  let betsMade = [];
  ...
  balls[0].addEventListener('endEvent', (event) => {
    ...
    rouletteElement.querySelector(".winner").textContent = winNumber;
  });
} */
...
export function renderRoulette() {
  //spinWheel();
    ...
    //const container = document.querySelector("#rouletteContainer");
    //document.body.appendChild(rouletteElement);
          
/*     roll = rouletteElement.querySelector(".roll");
    wheel = rouletteElement.querySelector("#rouletteWheel");
    ballAnim = rouletteElement.querySelector(".ballAnim"); // Ajoutez cette ligne */

    
 // Doit retourner l'élément, pas null
    return setupRoulette(rouletteElement)
      .then(() => {
...
export function setupRoulette(rouletteElement) {
  console.log(rouletteElement);

      roll = rouletteElement.querySelector(".roll");
      wheel = rouletteElement.querySelector("#rouletteWheel");
      ballAnim = rouletteElement.querySelector(".ballAnim");
