export function renderRoulette() {
    const rouletteHTML = `
    <button type="button" class="btn btn-primary glowing-btn" data-toggle="modal" data-target="#roulette">
    
    <span class='glowing-txt'>R<span class='faulty-letter'>O</span>ULETTE</span>
      </button>
    ...
    document.body.insertAdjacentHTML('afterbegin', rouletteHTML);
