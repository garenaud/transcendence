...
class LoadModelDemo {
  ...
  _Initialize() {
    ...
    // this._LoadAnimatedModelAndPlay(
        // './models/', 'Mexican.fbx', 'Breakdance.fbx', new THREE.Vector3(0, 1, 0));
    // this._LoadAnimatedModelAndPlay(
        // './models/', 'TheBoss.fbx', 'Run.fbx', new THREE.Vector3(12, 0, -10));
    // this._LoadAnimatedModelAndPlay(
  ...
  _LoadAnimatedModel() {
    ...
    loader.load('TheBoss.fbx', (fbx) => {
	  ...
	  const offset = new THREE.Vector3(0, -11, 0);
	  fbx.position.copy(offset);
	//   const quaternion = new THREE.Vector4(10, 10, 10, 10);
	//   fbx.quaternion.set(10, 10, 10, 10);
